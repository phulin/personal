...
const gwAssumptions: ScenarioSeries = {
	Anthropic: {
		bear: [0.17, 0.29, 0.62, 1.07, 1.7, 2.4, 4.4, 6.8],
		central: [0.17, 0.29, 0.62, 1.07, 2.1, 4.0, 5.2, 7.5],
		bull: [0.17, 0.29, 0.62, 1.07, 2.5, 4.8, 6.4, 8.0],
	},
	OpenAI: {
		bear: [0.25, 0.44, 0.81, 1.4, 2.2, 3.0, 4.0, 6.8],
		central: [0.25, 0.44, 0.81, 1.4, 2.6, 4.6, 5.9, 8.5],
		bull: [0.25, 0.44, 0.81, 1.4, 3.0, 5.2, 6.5, 9.0],
	},
};
